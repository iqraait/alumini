...
CSRF_TRUSTED_ORIGINS = [
    'https://globalalumini.iqraahospital.in',
    'http://globalalumini.iqraahospital.in',
]
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # ✅ UNCOMMENT THIS - For static files
...
# Local directories to search for static files
STATICFILES_DIRS = [
